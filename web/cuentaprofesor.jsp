<%-- 
    Document   : cuentaprofesor
    Created on : 7/12/2015, 10:45:31 PM
    Author     : Diego
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown active"><a href="cuentaprofesor.jsp">Mi Cuenta <i class="fa fa-angle-down"></i></a>
                        ...
                        <li class="dropdown"><a href="portfolio.html">Preguntas <i class="fa fa-angle-down"></i></a>
                            
                        </li> 
                        <li><a href="signin.jsp" class="btn btn-common">NOMBRE DE MI CUENTA</a></li>                        
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 padding-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
                    ...
                    <ul class="elements">
                        ...
                        <li class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><i class="fa fa-angle-right"></i>Numero de Cedula</li>
